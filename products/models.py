...
class ProductCategory(models.Model):
    name = models.CharField(max_length=128, unique=True)  # varchar(128)
...
class Basket(models.Model):
    ...
    def de_json(self):
        """
        returns a dictionary with Basket data (product_name, quantity, price, sum) for detailed view of order
        """
        basket_item = {
